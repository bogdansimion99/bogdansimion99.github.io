...
<!-- It is a Computer Vision system that does automatic refereeing by tracking the ball using a set of expensive cameras. The data collected by this system is incredibly valuable for any tennis player in preparing for a match, however, usually hidden behind a huge paywall.  -->
